...
keys = [
    ...
    Key([mod], "v", lazy.spawn("vivaldi"), desc="Reset all window sizes"),
    Key([mod], "m", lazy.spawn("rofi -show drun"), desc="Reset all window sizes"),
    Key([mod], "e", lazy.spawn("nautilus"), desc="Reset all window sizes"),
    Key([mod], "c", lazy.spawn("code"), desc="Reset all window sizes"),
...
autostart = [
    "feh --bg-fill /home/nano/Imágenes/bg.png",
    "picom &",
    "numlockx on &",
    "polybar main --config=/home/nano/.config/polybar/config.ini &",
    ]
